...
as$element){$this->renderElementHandler($element,'available');}?>
		...
		<div class="alert alert-warning">
			<span class="text"><?php _e('Elements are feature of Ait Elements Toolkit plugin. To use the full potential of your Page Builder, download plugin firstly.','ait-admin')?></span>
			<a href="https://www.ait-themes.club/wordpress-plugins/ait-elements-toolkit/" target="_blank" class="ait-button positive"><?php _e('Download Plugin','ait-admin')?></a>
		</div>
		<?php endif;?>
