...
// main template
//
NCoreMacros::includeTemplate($element->common('header'), $template->getParameters(), $_l->templates['nx9f0lfvza'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/items-info/javascript", ""), array() + get_defined_vars(), $_l->templates['nx9f0lfvza'])->render() ;