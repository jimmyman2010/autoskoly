...
define('WPLATTE_VERSION','2.9.1');class
WpLatte{public
...
function
homeUrl($isSearch=false){global$polylang;if(function_exists('PLL')){return!empty(PLL()->links)?PLL()->links->get_home_url(pll_current_language(),$isSearch):home_url('/');}if(isset($polylang)){return!empty($polylang->links)?$polylang->links->get_home_url(pll_current_language(),$isSearch):home_url('/');}return
home_url('/');}}class
WpLatteBaseEntity
extends
