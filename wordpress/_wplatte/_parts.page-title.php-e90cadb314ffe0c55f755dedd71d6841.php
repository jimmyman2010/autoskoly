<?php //netteCache[01]000558a:2:{s:4:"time";s:21:"0.27609700 1487389174";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:72:"E:\autoskoly\wordpress\wp-content\themes\directory2\parts\page-title.php";i:2;i:1487256889;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.1";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"1.72";}}}?><?php

// source file: E:\autoskoly\wordpress\wp-content\themes\directory2\parts\page-title.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'k8nupzthi3')
;
// prolog NUIMacros
...
<?php if (count($sString) > 0) { ?>
										<?php echo $template->printf(__('Výsledky vyhľadávania: %s', 'wplatte'), $searchTitle) ?>
...
<?php $eventProMeta = $post->meta('event-pro-data') ;ob_start() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/single-event-date", ""), array('meta' => $eventProMeta, 'place' => 'header', 'eventId' => $post->id) + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ;$eventDateIcon = ob_get_clean() ;} ?>
...
<?php $logo = AitLangs::getCurrentLocaleText($itemMeta->logo) ;} ?>
...
<?php $titleClass = "archive-title" ?>
	 ...
	 <?php if ($wp->isCategory) { ob_start() ?>
																	...
																	<?php echo $template->printf(__('Blog: %s', 'wplatte'), $categoryTitle) ?>
...
<?php $titleName = ob_get_clean() ?>
	 <?php } elseif ($wp->isTax) { ?>					<?php ob_start() ?>
																	...
																	<?php echo $template->printf(__('Blog: %s', 'wplatte'), $taxonomyTitle) ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $dateIcon, 'dateLinks' => $dateLinks, 'dateShort' => $dateShort) + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ;if (isset($eventDateIcon)) { ?>
						<?php echo $eventDateIcon ?>

<?php } ?>
				<div class="entry-title-wrap">

											<!--div class="cat-icon"><span <?php if (!empty($categoryColor)) { ?>
style="background: <?php echo $categoryColor ?>;"<?php } ?>><img src="<?php echo NTemplateHelpers::escapeHtmlComment($categoryIcon) ?>
" alt="<?php echo 'titleName' ?>"></span></div-->
<?php if ($logo) { ?>
						<div class="logo-icon">
							<span>
								<img src="<?php echo aitResizeImage($logo, array('height' => 200)) ?>" alt="" />
							</span>
						</div>
<?php } ?>
...
<?php } ?>
							...
							<?php if ($titleAuthor == 'yes') { ?> 		<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>
		<?php } ?>

							<?php if ($titleCategory == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>
	<?php } ?>

							<?php if ($titleComments == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>
		<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'left') + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'right') + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>
			</nav>
<?php } ?>

			</div>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/breadcrumbs", ""), array() + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>

		</header><!-- /.entry-header -->

		<!-- page title social icons -->
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/page-share", ""), array('showShare' => $pageShare) + get_defined_vars(), $_l->templates['k8nupzthi3'])->render() ?>
		<!-- page title social icons -->
