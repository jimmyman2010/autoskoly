<?php //netteCache[01]000591a:2:{s:4:"time";s:21:"0.19233300 1482290023";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:104:"D:\MANTRAN\autosloky\wordpress\wp-content\themes\directory2\ait-theme\elements\portfolio\portfolio.latte";i:2;i:1482236819;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.1";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"1.72";}}}?><?php

// source file: D:\MANTRAN\autosloky\wordpress\wp-content\themes\directory2\ait-theme\elements\portfolio\portfolio.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'tchbjecrr5')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($el->common('header'), $template->getParameters(), $_l->templates['tchbjecrr5'])->render() ?>
...
<?php $portfolios = $wp->categories('portfolios') ;$textRows = $el->option->textRows ?>
...
<?php $hasDesc = $el->option->imageDescription ? 'desc-present' : 'desc-missing' ?>

<?php if ($el->option('subcategoryItems')) { ?>
		--><li data-id="id-<?php echo NTemplateHelpers::escapeHtml($iterator->counter, ENT_COMPAT) ?>
" class="portfolio-item <?php echo NTemplateHelpers::escapeHtml($hasDesc, ENT_COMPAT) ?>
 <?php echo NTemplateHelpers::escapeHtml($item->catSlugs('ait-portfolios', ' ', 'portfolio-category-'), ENT_COMPAT) ?>
...
<?php } else { ?>
		--><li data-id="id-<?php echo NTemplateHelpers::escapeHtml($iterator->counter, ENT_COMPAT) ?>
" class="portfolio-item <?php echo NTemplateHelpers::escapeHtml($hasDesc, ENT_COMPAT) ?>
 <?php echo NTemplateHelpers::escapeHtml($item->categoriesSlugs('portfolio-category'), ENT_COMPAT) ?>
" <?php echo aitDataAttr('portfolio-sort-params', array('numeric' => $item->menuOrder, 'alphabetical' => $item->title, 'date' => $item->date('Y-m-d h:i:s'), 'random' => $rand)) ?>>
<?php } ?>
...
<?php if ($el->option->imageDescription) { ?>
					<div class="portfolio-item-desc-wrap">
						<div class="portfolio-item-desc">
							<h3><a href="<?php echo NTemplateHelpers::escapeHtml($url, ENT_COMPAT) ?>
" <?php if ($meta->type == 'website' and $el->option->display == 'colorbox') { ?>
target="_blank"<?php } ?> data-rel="portfolio-item-<?php echo NTemplateHelpers::escapeHtml($el->getHtmlId(), ENT_COMPAT) ?>
"><?php echo $item->title ?></a></h3>
							<p class="txtrows-<?php echo NTemplateHelpers::escapeHtml($textRows, ENT_COMPAT) ?>
"><?php echo $template->striptags($item->excerpt(150)) ?></p>
						</div>
					</div>
<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/portfolio/javascript", ""), array() + get_defined_vars(), $_l->templates['tchbjecrr5'])->render() ;