...
<?php $mapParams = array(
			...
			'markers'     => $markers,
			'params'      => $mapParams,
			'containerID' => $htmlId) + get_defined_vars(), $_l->templates['wu4xz1ej9b'])->render() ?>


<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/header-map/javascript", ""), array() + get_defined_vars(), $_l->templates['wu4xz1ej9b'])->render() ?>
</div>
