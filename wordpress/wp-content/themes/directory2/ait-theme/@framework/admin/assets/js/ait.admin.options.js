	...
	var ui = ait.admin.options.Ui = {
		...
		stickElements: function()
		{
			...
			if(ui.$stickToTopHeader.length && ui.$availableElements.length){
				...
				var stickToTopSidebarOffset = ui.$stickToTopHeader.parent().parent().offset().top - ui.stickToTopSidebarTopMargin - ui.wpAdminBarHeight;
				var availableElementsTopPosition = ui.$availableElements.offset().top - parseInt(ui.$stickToTopHeader.css('margin-top')) - 130;
				...
				$window.on('resize scroll', function() {
					...
					$.data(this, 'scrollTimer', setTimeout(function() {
						availableElementsTopPosition = ui.$availableElements.offset().top - parseInt(ui.$stickToTopHeader.css('margin-top')) - 130;
						stickToTopSidebarOffset = ui.$stickToTopHeader.parent().parent().offset().top - ui.stickToTopSidebarTopMargin - ui.wpAdminBarHeight;
						ui.setStickToTopSidebarDimensions(stickToTopSidebarOffset, availableElementsTopPosition);
					}, 300));
				});
			}
